...
Files:
SelectSort.java - program that takes in an array and sorts it using select sort
MergeSort.java - program that takes in an array and sorts it using merge sort
